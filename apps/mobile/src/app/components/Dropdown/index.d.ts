...
declare module "react-native-select-dropdown" {
  export type SelectDropdownProps = {
     ...
     */
    renderDropdownIcon?: (selectedItem: unknown, index: number) => React.ReactNode;
    /**
    ...
    */
     ...
     */
    renderSearchInputLeftIcon?: (selectedItem: unknown, index: number) => React.ReactNode;
    /**
    * function returns React component for search input icon
    */
    renderSearchInputRightIcon?: (selectedItem: unknown, index: number) => React.ReactNode;
  } & (
    {
      /**
       ...
       */
      buttonTextAfterSelection: (selectedItem: unknown, index: number) => string;
    } | {
      /**
       ...
       */
      renderCustomizedButtonChild?: (selectedItem: unknown, index: number) => React.ReactNode;
    }
  ) & (
    {
      /**
       ...
       */
      rowTextForSelection: (item: unknown, index: number) => string;
    } | {
      /**
       ...
       */
      renderCustomizedRowChild?: (selectedItem: unknown, index: number, isSelected?: boolean) => React.ReactNode;
    }
  );
